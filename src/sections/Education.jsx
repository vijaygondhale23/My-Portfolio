      ...
      <div className="container-max">
          ...
          {EDUCATION.map((edu, i) => (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                ...
                <span
                  style={{
                    ...
                    background: 'rgba(61,107,86,0.12)', border: '1px solid rgba(61,107,86,0.3)',
                    color: 'var(--accent-lt)',
                  }}
                >
                  {edu.type}
              ...
              <div style={{ marginTop: '16px' }}>
                <h3 style={{ fontSize: '18px', fontWeight: 700, color: '#fff', marginBottom: '6px' }}>{edu.degree}</h3>
                ...
                <div
                  style={{
                    ...
                    background: 'rgba(61,107,86,0.08)', border: '1px solid rgba(61,107,86,0.2)',
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '16px', fontWeight: 700, color: '#fff' }}>{edu.score}</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
            ...
            <p style={{ fontWeight: 600, fontSize: '16px', color: '#fff' }}>Certifications</p>
            ...
            {CERTIFICATIONS.map((cert) => (
              <a
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.style.borderColor = 'rgba(61,107,86,0.3)';
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <p style={{ fontWeight: 600, color: '#fff', fontSize: '15px', marginBottom: '4px' }}>{cert.title}</p>
